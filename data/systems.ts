...
export const systems: Record<SystemModel, { label: string; maxSockets: number; allowE: boolean; maxTdp?: number; description: string; lenovoPress?: string }> = {
  ...
  "st50-v3": { label: "ThinkSystem ST50 V3", maxSockets: 1, allowE: false, maxTdp: 125, description: "Entry level tower/server platform.", lenovoPress:"https://lenovopress.lenovo.com/lp1907-thinksystem-st50-v3-server" },
  "sr250-v3": { label: "ThinkSystem SR250 V3", maxSockets: 1, allowE: false, maxTdp: 95, description: "Entry level 1U server platform.", lenovoPress:"https://lenovopress.lenovo.com/lp1802-thinksystem-sr250-v3-server" },
...
export const defaultFilters: Filters = {
  ...
  maxTdp: 400, minSpec: 0, coreKind: "all", segment: "TCE"
};
