...
const cpuCatalog: Cpu[] = [
  ...
  { sku: "6511P", family: "Xeon 6500", codename: "Granite Rapids", coreType: "P-Cores", cores: 16, maxTurboGHz: 4.2, baseGHz: 2.3, cacheMB: 72, tdpW: 150, costUsd: 640, chips: 1, specInt2017: 195, maxScalability: "1S", segment: "mainstream" },
  ...
  { sku: "6521P", family: "Xeon 6500", codename: "Granite Rapids", coreType: "P-Cores", cores: 24, maxTurboGHz: 4.1, baseGHz: 2.6, cacheMB: 144, tdpW: 225, costUsd: 900, chips: 1, specInt2017: 296, maxScalability: "1S", segment: "mainstream" },
  ...
  { sku: "6714P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-Cores", cores: 8, maxTurboGHz: 4.3, baseGHz: 4.0, cacheMB: 48, tdpW: 165, costUsd: 2250, chips: 2, specInt2017: 210, maxScalability: "2S", segment: "extended" },
  { sku: "6724P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-Cores", cores: 16, maxTurboGHz: 4.3, baseGHz: 3.6, cacheMB: 72, tdpW: 210, costUsd: 2467, chips: 2, specInt2017: 402, maxScalability: "2S", segment: "extended" },
  ...
  { sku: "6738P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-Cores", cores: 32, maxTurboGHz: 4.2, baseGHz: 2.9, cacheMB: 144, tdpW: 270, costUsd: 3500, chips: 4, specInt2017: 1460, maxScalability: "4S", segment: "extended" },
  ...
  { sku: "6740P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-Cores", cores: 48, maxTurboGHz: 3.8, baseGHz: 2.1, cacheMB: 288, tdpW: 270, costUsd: 2700, chips: 2, specInt2017: 972, maxScalability: "2S", segment: "extended" },
  ...
  { sku: "6748P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-Cores", cores: 48, maxTurboGHz: 4.1, baseGHz: 2.5, cacheMB: 192, tdpW: 300, costUsd: 10049, chips: 4, specInt2017: 2010, maxScalability: "4S", segment: "extended" },
  ...
  { sku: "6767P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-Cores", cores: 64, maxTurboGHz: 3.9, baseGHz: 2.4, cacheMB: 336, tdpW: 350, costUsd: 4450, chips: 2, specInt2017: 1300, maxScalability: "2S", segment: "extended" },
  { sku: "6768P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-Cores", cores: 64, maxTurboGHz: 3.9, baseGHz: 2.4, cacheMB: 336, tdpW: 330, costUsd: 12226, chips: 4, specInt2017: 2490, maxScalability: "4S", segment: "extended" },
  ...
  { sku: "6787P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-Cores", cores: 86, maxTurboGHz: 3.8, baseGHz: 2.0, cacheMB: 336, tdpW: 350, costUsd: 4300, chips: 2, specInt2017: 1540, maxScalability: "2S", segment: "extended" },
  { sku: "6788P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-Cores", cores: 86, maxTurboGHz: 3.8, baseGHz: 2.0, cacheMB: 336, tdpW: 350, costUsd: 14520, chips: 4, specInt2017: 2910, maxScalability: "4S", segment: "extended" }
];
  ...
  return <main style={{ minHeight: "100vh", padding: 14, background: "radial-gradient(circle at 35% 10%,#0b2740 0,#06111d 35%,#020812 100%)" }}>
    ...
    <section className="dashboard" style={{ display: "grid", gridTemplateColumns: "320px 1fr 1.55fr 1.25fr", gap: 8 }}>
      <Panel><div style={{ padding: "12px 16px", borderBottom: "1px solid rgba(97,145,175,.25)", display: "flex", justifyContent: "space-between" }}><b>FILTERS</b><button onClick={() => { setPending(defaultFilters); setFilters(defaultFilters); }} style={{ background: "transparent", border: 0, color: "#18a8ff" }}>Reset All</button></div><div style={{ padding: 14 }}>
        ...
        <Select label="CPU Segment" value={pending.segment} onChange={v => setPending({ ...pending, segment: v as Filters["segment"] })} opts={[["all", "All (Extended + Mainstream + TCE)"], ["extended", "Extended CPU"], ["mainstream", "Mainstream CPU"], ["tce", "TCE"]]} />
