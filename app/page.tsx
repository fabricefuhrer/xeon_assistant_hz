...
export default function Page() {
  ...
  const exportPdf = async () => {
    ...
    line("Segment",top.segment);line("Core Type",top.coreType);line("Cores / CPU",String(top.cores));line("Max Turbo",`${top.maxTurboGHz} GHz`);line("TDP / CPU",`${top.tdpW} W`);line("SPECint2017",top.specInt2017.toLocaleString());line("CPU Price / Unit",fmtMoney(top.costUsd));line("CPU Investment",fmtMoney(top.costUsd*qty));y+=4;
