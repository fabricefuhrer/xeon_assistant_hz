...
const cpuCatalog: Cpu[] = [
  { sku: "6315P", family: "Xeon 6300", codename: "Raptor Lake", coreType: "P-cores", cores: 4, maxTurboGHz: 5.2, baseGHz: 2.8, cacheMB: 12, tdpW: 55, costUsd: 199, chips: 1, specInt2017: 41.6, maxScalability: "1S" },
  { sku: "6325P", family: "Xeon 6300", codename: "Raptor Lake", coreType: "P-cores", cores: 4, maxTurboGHz: 5.2, baseGHz: 3.5, cacheMB: 12, tdpW: 55, costUsd: 253, chips: 1, specInt2017: 50.9, maxScalability: "1S" },
  { sku: "6333P", family: "Xeon 6300", codename: "Raptor Lake", coreType: "P-cores", cores: 6, maxTurboGHz: 4.7, baseGHz: 3.1, cacheMB: 18, tdpW: 65, costUsd: 287, chips: 1, specInt2017: 71.1, maxScalability: "1S" },
  { sku: "6337P", family: "Xeon 6300", codename: "Raptor Lake", coreType: "P-cores", cores: 6, maxTurboGHz: 5.3, baseGHz: 3.5, cacheMB: 18, tdpW: 80, costUsd: 337, chips: 1, specInt2017: 75.8, maxScalability: "1S" },
  { sku: "6349P", family: "Xeon 6300", codename: "Raptor Lake", coreType: "P-cores", cores: 6, maxTurboGHz: 5.7, baseGHz: 3.6, cacheMB: 18, tdpW: 95, costUsd: 455, chips: 1, specInt2017: 79.2, maxScalability: "1S" },
  { sku: "6353P", family: "Xeon 6300", codename: "Raptor Lake", coreType: "P-cores", cores: 8, maxTurboGHz: 5.4, baseGHz: 2.7, cacheMB: 24, tdpW: 65, costUsd: 383, chips: 1, specInt2017: 84.4, maxScalability: "1S" },
  { sku: "6357P", family: "Xeon 6300", codename: "Raptor Lake", coreType: "P-cores", cores: 8, maxTurboGHz: 5.4, baseGHz: 3.0, cacheMB: 24, tdpW: 80, costUsd: 500, chips: 1, specInt2017: 96.6, maxScalability: "1S" },
  { sku: "6369P", family: "Xeon 6300", codename: "Raptor Lake", coreType: "P-cores", cores: 8, maxTurboGHz: 5.7, baseGHz: 3.3, cacheMB: 24, tdpW: 95, costUsd: 545, chips: 1, specInt2017: 98.8, maxScalability: "1S" },

  { sku: "6505P", family: "Xeon 6500", codename: "Granite Rapids", coreType: "P-cores", cores: 12, maxTurboGHz: 4.1, baseGHz: 2.2, cacheMB: 48, tdpW: 150, costUsd: 435, chips: 2, specInt2017: 286, maxScalability: "2S" },
  { sku: "6507P", family: "Xeon 6500", codename: "Granite Rapids", coreType: "P-cores", cores: 8, maxTurboGHz: 4.3, baseGHz: 3.5, cacheMB: 48, tdpW: 150, costUsd: 551, chips: 2, specInt2017: 210, maxScalability: "2S" },
  { sku: "6511P", family: "Xeon 6500", codename: "Granite Rapids", coreType: "P-cores", cores: 16, maxTurboGHz: 4.2, baseGHz: 2.3, cacheMB: 72, tdpW: 150, costUsd: 640, chips: 1, specInt2017: 195, maxScalability: "1S" },
  { sku: "6515P", family: "Xeon 6500", codename: "Granite Rapids", coreType: "P-cores", cores: 16, maxTurboGHz: 3.8, baseGHz: 2.3, cacheMB: 72, tdpW: 150, costUsd: 515, chips: 2, specInt2017: 373, maxScalability: "2S" },
  { sku: "6517P", family: "Xeon 6500", codename: "Granite Rapids", coreType: "P-cores", cores: 16, maxTurboGHz: 4.2, baseGHz: 3.2, cacheMB: 72, tdpW: 190, costUsd: 850, chips: 2, specInt2017: 388, maxScalability: "2S" },
  { sku: "6520P", family: "Xeon 6500", codename: "Granite Rapids", coreType: "P-cores", cores: 24, maxTurboGHz: 4.0, baseGHz: 2.4, cacheMB: 144, tdpW: 210, costUsd: 950, chips: 2, specInt2017: 522, maxScalability: "2S" },
  { sku: "6521P", family: "Xeon 6500", codename: "Granite Rapids", coreType: "P-cores", cores: 24, maxTurboGHz: 4.1, baseGHz: 2.6, cacheMB: 144, tdpW: 225, costUsd: 900, chips: 1, specInt2017: 296, maxScalability: "1S" },
  { sku: "6527P", family: "Xeon 6500", codename: "Granite Rapids", coreType: "P-cores", cores: 24, maxTurboGHz: 4.2, baseGHz: 3.0, cacheMB: 144, tdpW: 255, costUsd: 1910, chips: 2, specInt2017: 592, maxScalability: "2S" },
  { sku: "6530P", family: "Xeon 6500", codename: "Granite Rapids", coreType: "P-cores", cores: 32, maxTurboGHz: 4.1, baseGHz: 2.3, cacheMB: 144, tdpW: 225, costUsd: 1800, chips: 2, specInt2017: 706, maxScalability: "2S" },

  { sku: "6710E", family: "Xeon 6700", codename: "Sierra Forest", coreType: "E-cores", cores: 64, maxTurboGHz: 3.2, baseGHz: 2.4, cacheMB: 96, tdpW: 205, costUsd: 1181, chips: 2, specInt2017: 695, maxScalability: "2S" },
  { sku: "6714P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 8, maxTurboGHz: 4.3, baseGHz: 4.0, cacheMB: 48, tdpW: 165, costUsd: 2250, chips: 2, specInt2017: 210, maxScalability: "2S" },
  { sku: "6724P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 16, maxTurboGHz: 4.3, baseGHz: 3.6, cacheMB: 72, tdpW: 210, costUsd: 2467, chips: 2, specInt2017: 402, maxScalability: "2S" },
  { sku: "6728P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 24, maxTurboGHz: 4.1, baseGHz: 2.7, cacheMB: 144, tdpW: 210, costUsd: 1450, chips: 4, specInt2017: 1120, maxScalability: "4S" },
  { sku: "6731E", family: "Xeon 6700", codename: "Sierra Forest", coreType: "E-cores", cores: 96, maxTurboGHz: 3.1, baseGHz: 2.2, cacheMB: 96, tdpW: 250, costUsd: 1209, chips: 1, specInt2017: 493, maxScalability: "1S" },
  { sku: "6731P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 32, maxTurboGHz: 4.1, baseGHz: 2.5, cacheMB: 144, tdpW: 245, costUsd: 1700, chips: 1, specInt2017: 371, maxScalability: "1S" },
  { sku: "6736P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 36, maxTurboGHz: 4.1, baseGHz: 2.0, cacheMB: 144, tdpW: 205, costUsd: 2400, chips: 2, specInt2017: 735, maxScalability: "2S" },
  { sku: "6737P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 32, maxTurboGHz: 4.0, baseGHz: 2.9, cacheMB: 144, tdpW: 270, costUsd: 2750, chips: 2, specInt2017: 749, maxScalability: "2S" },
  { sku: "6738P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 32, maxTurboGHz: 4.2, baseGHz: 2.9, cacheMB: 144, tdpW: 270, costUsd: 3500, chips: 4, specInt2017: 1460, maxScalability: "4S" },
  { sku: "6740E", family: "Xeon 6700", codename: "Sierra Forest", coreType: "E-cores", cores: 96, maxTurboGHz: 3.2, baseGHz: 2.4, cacheMB: 96, tdpW: 250, costUsd: 1331, chips: 2, specInt2017: 979, maxScalability: "2S" },
  { sku: "6740P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 48, maxTurboGHz: 3.8, baseGHz: 2.1, cacheMB: 288, tdpW: 270, costUsd: 2700, chips: 2, specInt2017: 972, maxScalability: "2S" },
  { sku: "6745P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 32, maxTurboGHz: 4.3, baseGHz: 3.1, cacheMB: 336, tdpW: 300, costUsd: 3048, chips: 2, specInt2017: 785, maxScalability: "2S" },
  { sku: "6746E", family: "Xeon 6700", codename: "Sierra Forest", coreType: "E-cores", cores: 112, maxTurboGHz: 2.7, baseGHz: 2.0, cacheMB: 96, tdpW: 250, costUsd: 1230, chips: 2, specInt2017: 1020, maxScalability: "2S" },
  { sku: "6748P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 48, maxTurboGHz: 4.1, baseGHz: 2.5, cacheMB: 192, tdpW: 300, costUsd: 10049, chips: 4, specInt2017: 2010, maxScalability: "4S" },
  { sku: "6756E", family: "Xeon 6700", codename: "Sierra Forest", coreType: "E-cores", cores: 128, maxTurboGHz: 2.6, baseGHz: 1.8, cacheMB: 96, tdpW: 225, costUsd: 1747, chips: 2, specInt2017: 1100, maxScalability: "2S" },
  { sku: "6760P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 64, maxTurboGHz: 3.8, baseGHz: 2.2, cacheMB: 320, tdpW: 330, costUsd: 3600, chips: 2, specInt2017: 1250, maxScalability: "2S" },
  { sku: "6761P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 64, maxTurboGHz: 3.9, baseGHz: 2.5, cacheMB: 336, tdpW: 350, costUsd: 3600, chips: 1, specInt2017: 663, maxScalability: "1S" },
  { sku: "6766E", family: "Xeon 6700", codename: "Sierra Forest", coreType: "E-cores", cores: 144, maxTurboGHz: 2.7, baseGHz: 1.9, cacheMB: 108, tdpW: 250, costUsd: 2217, chips: 2, specInt2017: 1240, maxScalability: "2S" },
  { sku: "6767P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 64, maxTurboGHz: 3.9, baseGHz: 2.4, cacheMB: 336, tdpW: 350, costUsd: 4450, chips: 2, specInt2017: 1300, maxScalability: "2S" },
  { sku: "6768P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 64, maxTurboGHz: 3.9, baseGHz: 2.4, cacheMB: 336, tdpW: 330, costUsd: 12226, chips: 4, specInt2017: 2490, maxScalability: "4S" },
  { sku: "6780E", family: "Xeon 6700", codename: "Sierra Forest", coreType: "E-cores", cores: 144, maxTurboGHz: 3.0, baseGHz: 2.2, cacheMB: 108, tdpW: 330, costUsd: 2354, chips: 2, specInt2017: 1350, maxScalability: "2S" },
  { sku: "6781P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 80, maxTurboGHz: 3.8, baseGHz: 2.0, cacheMB: 336, tdpW: 350, costUsd: 4000, chips: 1, specInt2017: 745, maxScalability: "1S" },
  { sku: "6787P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 86, maxTurboGHz: 3.8, baseGHz: 2.0, cacheMB: 336, tdpW: 350, costUsd: 4300, chips: 2, specInt2017: 1540, maxScalability: "2S" },
  { sku: "6788P", family: "Xeon 6700", codename: "Granite Rapids", coreType: "P-cores", cores: 86, maxTurboGHz: 3.8, baseGHz: 2.0, cacheMB: 336, tdpW: 350, costUsd: 14520, chips: 4, specInt2017: 2910, maxScalability: "4S" }
];
...
function Panel({children,className="",style}:{children:React.ReactNode;className?:string;style?:React.CSSProperties}){ return <div className={`panel ${className}`} style={{background:"linear-gradient(180deg,rgba(10,27,42,.96),rgba(5,17,27,.96))",border:"1px solid #25445c",borderRadius:8,boxShadow:"0 16px 50px rgba(0,0,0,.28)",overflow:"hidden",...style}}>{children}</div> }
